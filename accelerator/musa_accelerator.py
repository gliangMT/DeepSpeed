...
# For newest torch_musa, the package is not a must
try:
...
class MUSA_Accelerator(DeepSpeedAccelerator):
    ...
    def __init__(self):
        ...
        # to do: initialize class_dict for op_builder
    ...
    #     """
    #     credit: https://discuss.pytorch.org/t/making-pynvml-match-torch-device-ids-musa-visible-devices/103020
    ...
    def is_fp16_supported(self):
        ...
        if major >= 3:
            return True
        elif major == 2 and _ == 2:  # e.g.MTT S4000
            return True
        else:
            return False
    ...
    def lazy_call(self, callback):
        return torch.musa.core._lazy_init._lazy_call(callback)
                ...
                if module_name != 'all_ops' and module_name != 'builder' and not os.path.isdir(
                    ...
                    for member_name in module.__dir__():
                        if member_name.endswith(
                                'Builder'
                        ) and member_name != "OpBuilder" and member_name != "CUDAOpBuilder" and member_name != "TorchCPUOpBuilder" and member_name != "MUSAOpBuilder":  # avoid abstract classes
